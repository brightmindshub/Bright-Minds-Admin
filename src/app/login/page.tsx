...
import { Lock, User, Eye, EyeOff, ShieldCheck, Sparkles, ArrowRight, CheckCircle2 } from "lucide-react";
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (username === "admin" && password === "brightminds123") {
        ...
        // Redirection after animation completes
        setTimeout(() => {
    ...
    <div className="h-screen w-full flex bg-white font-sans overflow-hidden relative">
        ...
        {loginSuccess && (
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <motion.div 
                className="mt-12 w-48 h-[2px] bg-white/10 mx-auto rounded-full overflow-hidden"
              >
                <motion.div 
                  initial={{ width: 0 }}
                  animate={{ width: "100%" }}
      ...
      <div className="hidden lg:flex w-1/2 bg-[#19125e] relative items-center justify-center p-20">
        ...
        <div className="absolute top-20 left-20">
          <Image src="/brightMindsAcademy-logo.jpeg" width={220} height={80} alt="logo" className="rounded-2xl brightness-125 shadow-2xl" />
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-16 lg:p-24 bg-[#fcfdfe]">
        ...
        >
          <div className="lg:hidden mb-10 text-center">
             <Image src="/brightMindsAcademy-logo.jpeg" width={180} height={60} alt="logo" className="rounded-xl mx-auto shadow-xl" />
          </div>

          <div className="mb-12">
            <h2 className="text-4xl font-black text-[#19125e] uppercase tracking-tighter italic">Sign In</h2>
            <p className="text-gray-400 font-bold text-[10px] uppercase tracking-[0.4em] mt-2">Admin Access Only</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-8">
            <div className="space-y-6">
              <div className="group relative border-b-2 border-gray-100 focus-within:border-[#19125e] transition-all pb-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-300 group-focus-within:text-[#f0c44c]">Username</label>
                <div className="flex items-center gap-3 mt-1">
                  <User size={18} className="text-gray-200 group-focus-within:text-[#19125e]" />
                  <input 
                    type="text" 
              ...
              <div className="group relative border-b-2 border-gray-100 focus-within:border-[#19125e] transition-all pb-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-300 group-focus-within:text-[#f0c44c]">Password</label>
                <div className="flex items-center gap-3 mt-1">
                  <Lock size={18} className="text-gray-200 group-focus-within:text-[#19125e]" />
                  <input 
                  ...
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="text-gray-200 hover:text-[#19125e]">
            ...
            {error && (
              <motion.div initial={{ x: -10 }} animate={{ x: 0 }} className="flex items-center gap-2 text-red-500">
            ...
            <div className="pt-6">
              ...
              >
                ...
                <ArrowRight size={16} className="group-hover:translate-x-2 transition-transform text-[#f0c44c]" />
              </button>
            </div>
          </form>

          <footer className="mt-20 flex justify-center items-center border-t border-gray-50 pt-8">
            <p className="text-[9px] font-bold text-gray-300 uppercase tracking-widest">© 2026 Bright Minds Academy</p>
          </footer>
        </motion.div>
      </div>
    </div>
